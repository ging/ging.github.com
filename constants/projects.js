export const projects = [
  ...
  },
  {
    ...
    description_en:
      "The IGLUE project aims to empower universities to create and conduct pedagogically sound educational escape rooms and promote the widespread use and adoption of such innovative learning activities across Europe.",
    description_es:
      "El proyecto IGLUE tiene como objetivo capacitar a las universidades para crear y llevar a cabo escape rooms educativas pedagógicamente sólidas y promover el uso y la adopción generalizada de estas innovadoras actividades de aprendizaje en toda Europa.",
  ...
  },
  {
    ...
    description_es:
      "SGAME es una plataforma web gratuita dirigida a la comunidad educativa que permite crear fácilmente juegos educativos web integrando recursos educativos en juegos existentes.",
    researchLine: ["e-learning"],
    projectType: "national-project",
  },
  {
  ...
  },
  {
    ...
    description_es:
      "Este proyecto integra el DSI eID en la plataforma FIWARE, que proporciona un conjunto de APIs (Interfaces de Programación de Aplicaciones) para el desarrollo de Aplicaciones Inteligentes en sectores orientados a Internet del Futuro. Se desarrollará el Gestor de Identidad FIWARE - pasarela de autenticación eIDAS uniendo tanto eIDAS como el Gestor de Identidad FIWARE. Tras la integración de eID DSI con la Gestión de Identidad FIWARE y el General Enabler de Control de Acceso, es posible acceder a los servicios del ecosistema FIWARE con los eIDs eIDAS de los ciudadanos de la UE.",
    researchLine: ["data"],
    projectType: "european-project",
  },
  {
    ...
    description_es:
      "Este proyecto integra los eIDs nacionales compatibles con eIDAS en los servicios ofrecidos por el mundo académico europeo. Creamos una tarjeta de estudiante virtual basada en los atributos estándar de eIDAS para personas físicas, ampliados con aquellos nuevos atributos requeridos para el entorno académico. Integramos la solución en varios servicios de las universidades que forman parte del consorcio (UPM, POLITO, ULISBOA, JSI y Universidad de Graz).",
    researchLine: ["e-learning", "data"],
    projectType: "european-project",
  },
  {
  ...
  },
  {
    ...
    description_es:
      "El proyecto GLOBAL (Global Linkage Over BroadbAnd Links) estudia, conferencias y acciones de coordinación que apoyan el desarrollo de políticas, incluida la cooperación internacional, para las e-Infraestructuras.",
  ...
  },
  {
    ...
    description_es:
      "ViSH Editor es una herramienta de autoría de e-learning de código abierto que permite crear presentaciones web de forma sencilla y amigable.",
